          ...
          <div className="relative p-6 flex-auto">
            ...
            <div className="mt-4 mb-2 sm:mb-4">
              <button
                ...
                type="submit"
                className="inline-flex items-center justify-center h-12 px-10 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-400 hover:bg-deep-purple-700 focus:shadow-outline focus:outline-none background"
